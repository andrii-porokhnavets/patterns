...
class SomeComponent:
    ...
    def __copy__(self):
        new = self.__class__(self.some_int, self.some_list_of_objects, self.some_circular_ref)
...
if __name__ == "__main__":
    ...
    if component.some_list_of_objects[-1] == "another object":
        print("Adding elements to `shallow_copied_component`'s some_list_of_objects adds it to `component`'s "
              "some_list_of_objects.")
    else:
        print("Adding elements to `shallow_copied_component`'s some_list_of_objects doesn't add it to `component`'s "
              "some_list_of_objects.")

    # Let's change the set in the list of objects.
    shallow_copied_component.some_list_of_objects[1].add(4)
    if 4 in shallow_copied_component.some_list_of_objects[1]:
        print("Changing objects in the `component`'s some_list_of_objects changes that object in "
              "`shallow_copied_component`'s some_list_of_objects.")
    else:
        print("Changing objects in the `component`'s some_list_of_objects doesn't change that object in "
              "`shallow_copied_component`'s some_list_of_objects.")
    ...
    if component.some_list_of_objects[-1] == "another object":
        print("Adding elements to `deep_copied_component`'s some_list_of_objects adds it to `component`'s "
              "some_list_of_objects.")
    else:
        print("Adding elements to `deep_copied_component`'s some_list_of_objects doesn't add it to `component`'s "
              "some_list_of_objects.")
